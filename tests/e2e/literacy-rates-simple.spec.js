...
test.describe('Literacy Rates - Requisitos Funcionales', () => {
  ...
  test('1. Crear un recurso', async ({ page }) => {
    ...
    const resource = page.locator('[data-testid="table-row-TestPais-2024"]');
  ...
  test('2. Listar todos los recursos', async ({ page }) => {
    ...
    const table = page.locator('[data-testid="literacy-rates-table"]');
  ...
  test('4. Borrar un recurso concreto', async ({ page }) => {
    ...
    const resource = page.locator('[data-testid="table-row-DeleteTest-2024"]');
